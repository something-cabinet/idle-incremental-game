...
export const MATERIALS: MaterialDef[] = [
  { id: 'beast-pelt', name: 'Beast Pelt', icon: 'hide' },
  { id: 'iron-ore', name: 'Iron Ore', icon: 'ore' },
  { id: 'spirit-essence', name: 'Spirit Essence', icon: 'sparkle' },
  { id: 'demon-ash', name: 'Demon Ash', icon: 'flame' },
  { id: 'raw-meat', name: 'Raw Meat', icon: 'hide' },
  { id: 'herbs', name: 'Wild Herbs', icon: 'flora' },
  { id: 'timber', name: 'Timber', icon: 'flora' },
  { id: 'silk', name: 'Spider Silk', icon: 'flora' },
  { id: 'crystal', name: 'Crystal Shard', icon: 'gem' },
  // ---- Disassembly byproducts (see guild.ts disassembleItem) ----
  // All five share the flask shape; rarity is carried by colour, not outline.
  { id: 'common-essence', name: 'Common Essence', icon: 'essence' },
  { id: 'rare-essence', name: 'Rare Essence', icon: 'essence' },
  { id: 'epic-essence', name: 'Epic Essence', icon: 'essence' },
  { id: 'exalted-essence', name: 'Exalted Essence', icon: 'essence' },
  { id: 'ascendant-essence', name: 'Ascendant Essence', icon: 'essence' },
];
...
export const EQUIP_TYPES: EquipTypeDef[] = [
  ...
  { id: 'sword', slot: 'weapon', names: ['Sword', 'Blade', 'Saber'], icon: 'blade',
    scaling: 'str', atkShare: 0.8, budgetMult: 1.0, bonusAttrs: ['str', 'dex'] },
  { id: 'greatsword', slot: 'weapon', names: ['Greatsword', 'Claymore', 'Zweihander'], icon: 'blade',
    scaling: 'str', atkShare: 0.9, budgetMult: 1.2, bonusAttrs: ['str', 'con'] },
  { id: 'axe', slot: 'weapon', names: ['Axe', 'War Axe', 'Cleaver'], icon: 'axe',
    scaling: 'str', atkShare: 0.85, budgetMult: 1.1, bonusAttrs: ['str', 'con'] },
  { id: 'mace', slot: 'weapon', names: ['Mace', 'Warhammer', 'Morningstar'], icon: 'hammer',
    scaling: 'str', atkShare: 0.75, budgetMult: 1.05, bonusAttrs: ['str', 'res'] },
  { id: 'dagger', slot: 'weapon', names: ['Dagger', 'Dirk', 'Stiletto'], icon: 'blade',
    scaling: 'dex', atkShare: 0.85, budgetMult: 0.9, bonusAttrs: ['dex', 'lck'] },
  { id: 'bow', slot: 'weapon', names: ['Bow', 'Longbow', 'Recurve Bow'], icon: 'bow',
    scaling: 'dex', atkShare: 0.9, budgetMult: 1.05, bonusAttrs: ['dex', 'lck'] },
  { id: 'crossbow', slot: 'weapon', names: ['Crossbow', 'Arbalest', 'Repeater'], icon: 'bow',
    scaling: 'dex', atkShare: 0.9, budgetMult: 1.15, bonusAttrs: ['dex', 'str'] },
  { id: 'wand', slot: 'weapon', names: ['Wand', 'Scepter', 'Rod'], icon: 'staff',
    scaling: 'int', atkShare: 0.85, budgetMult: 0.95, bonusAttrs: ['int', 'lck'] },
  { id: 'staff', slot: 'weapon', names: ['Staff', 'Warstaff', 'Greatstaff'], icon: 'staff',
    scaling: 'int', atkShare: 0.9, budgetMult: 1.15, bonusAttrs: ['int', 'res'] },
  // ---- Armor: def-heavy, biggest HP share ----
  { id: 'plate', slot: 'armor', names: ['Plate Armor', 'Breastplate', 'Full Plate'], icon: 'plate',
    atkShare: 0.1, budgetMult: 1.25, bonusAttrs: ['con', 'str'], hpShare: 0.35 },
  { id: 'mail', slot: 'armor', names: ['Chainmail', 'Hauberk', 'Scale Mail'], icon: 'plate',
    atkShare: 0.15, budgetMult: 1.1, bonusAttrs: ['con', 'res'], hpShare: 0.35 },
  { id: 'leather', slot: 'armor', names: ['Leather Armor', 'Brigandine', 'Jerkin'], icon: 'cloth',
    atkShare: 0.2, budgetMult: 1.0, bonusAttrs: ['dex', 'con'], hpShare: 0.35 },
  { id: 'cloak', slot: 'armor', names: ['Cloak', 'Mantle', 'Shroud'], icon: 'cloth',
    atkShare: 0.25, budgetMult: 0.85, bonusAttrs: ['dex', 'lck'], hpShare: 0.35 },
  { id: 'robe', slot: 'armor', names: ['Robe', 'Vestment', 'Raiment'], icon: 'cloth',
    atkShare: 0.2, budgetMult: 0.9, bonusAttrs: ['int', 'res'], hpShare: 0.35 },
  // ---- Trinkets: balanced, smaller HP share ----
  { id: 'ring', slot: 'trinket', names: ['Ring', 'Signet', 'Band'], icon: 'ring',
    atkShare: 0.5, budgetMult: 0.7, bonusAttrs: ['dex', 'lck'], hpShare: 0.2 },
  { id: 'amulet', slot: 'trinket', names: ['Amulet', 'Pendant', 'Locket'], icon: 'amulet',
    atkShare: 0.4, budgetMult: 0.7, bonusAttrs: ['int', 'res'], hpShare: 0.2 },
  { id: 'charm', slot: 'trinket', names: ['Charm', 'Fetish', 'Keepsake'], icon: 'ring',
    atkShare: 0.5, budgetMult: 0.7, bonusAttrs: ['lck', 'int'], hpShare: 0.2 },
  { id: 'idol', slot: 'trinket', names: ['Idol', 'Totem', 'Effigy'], icon: 'amulet',
